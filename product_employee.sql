...
/* NOT LIKE */
SELECT * FROM  Employee where employee_department NOT LIKE 'K%' ;
SELECT * FROM  Employee where empoyee_name NOT LIKE 'T%' ;
SELECT * FROM  Employee where manager_name NOT LIKE 'L%' ;
SELECT * FROM  Employee where employee_experience NOT LIKE '2%' ;
SELECT * FROM  Employee where employee_salary NOT LIKE '6%' ;
...
SELECT * FROM Employee ORDER BY employee_experience;
SELECT * FROM Employee ORDER BY manager_name;
SELECT * FROM Employee ORDER BY empoyee_name;
SELECT * FROM Employee ORDER BY id;


/* ORDER BY FOR DESCENDING ORDER*/
SELECT * FROM Employee ORDER BY id desc;
SELECT * FROM Employee ORDER BY employee_department desc;
SELECT * FROM Employee ORDER BY employee_salary desc;


/* LIMIT */
SELECT * FROM Employee ORDER BY id LIMIT 5;
SELECT * FROM Employee ORDER BY id desc LIMIT 5; /* for descending limit*/
SELECT * FROM Employee ORDER BY manager_name LIMIT 7;
SELECT * FROM Employee ORDER BY employee_salary LIMIT 12;
SELECT * FROM Employee ORDER BY employee_experience LIMIT 9;


/* LENGTH */
SELECT empoyee_name, LENGTH(empoyee_name)FROM Employee;
SELECT manager_name, LENGTH(manager_name)FROM Employee;
SELECT employee_department, LENGTH(employee_department)FROM Employee;
SELECT employee_salary, LENGTH(employee_salary)FROM Employee;
SELECT manager_id, LENGTH(manager_id)FROM Employee;


/* LOWER */
SELECT LOWER(empoyee_name) FROM Employee; 
SELECT LOWER(manager_name) FROM Employee; 
SELECT LOWER(employee_department) FROM Employee; 


/* UPPER */
SELECT UPPER(empoyee_name) FROM Employee; 
SELECT UPPER(employee_department) FROM Employee; 
SELECT UPPER(manager_name) FROM Employee; 


/* INSTR - INSTRING */
SELECT INSTR(manager_name,'a'),manager_name FROM Employee;
SELECT INSTR(empoyee_name,'h'),empoyee_name FROM Employee;
SELECT INSTR(employee_department,'s'),employee_department FROM Employee;
SELECT INSTR(empoyee_name,'t'),empoyee_name FROM Employee;
SELECT INSTR(manager_name,'m'),manager_name FROM Employee;
...
/* NOT LIKE */
SELECT * FROM  Product where product_brand NOT LIKE 'D%' ;
SELECT * FROM  Product where manufactured_by NOT LIKE 'T%' ;
SELECT * FROM  Product where product_name NOT LIKE 'P%' ;
SELECT * FROM  Product where expiry_date NOT LIKE '02%' ;
SELECT * FROM  Product where product_quantity NOT LIKE '8%' ;
...
SELECT * FROM Product ORDER BY product_quantity;
SELECT * FROM Product ORDER BY product_brand;
...
SELECT * FROM Product ORDER BY product_quantity desc;


/* LIMIT */
SELECT * FROM Product ORDER BY id LIMIT 5;
SELECT * FROM Product ORDER BY id desc LIMIT 5; /* for descending limit*/
SELECT * FROM Product ORDER BY product_name LIMIT 7;
SELECT * FROM Product ORDER BY product_price LIMIT 12;
SELECT * FROM Product ORDER BY product_quantity LIMIT 9;


/* LENGTH */
SELECT product_name, LENGTH(product_name)FROM Product;
SELECT manufactured_by, LENGTH(manufactured_by)FROM Product;
SELECT product_brand, LENGTH(product_brand)FROM Product;
SELECT product_price, LENGTH(product_price)FROM Product;
SELECT product_quantity, LENGTH(product_quantity)FROM Product;


/* LOWER */
SELECT LOWER(product_name) FROM Product; 
SELECT LOWER(product_brand) FROM Product; 
SELECT LOWER(manufactured_by) FROM Product; 


/* UPPER */
SELECT UPPER(product_brand) FROM Product; 
SELECT UPPER(product_name) FROM Product; 
SELECT UPPER(manufactured_by) FROM Product; 


/* INSTR - INSTRING */
SELECT INSTR(product_name,'k'),product_name FROM Product;
SELECT INSTR(product_brand,'t'),product_brand FROM Product;
SELECT INSTR(manufactured_by,'h'),manufactured_by FROM Product;
SELECT INSTR(product_name,'s'),product_name FROM Product;
SELECT INSTR(product_brand,'a'),product_brand FROM Product;

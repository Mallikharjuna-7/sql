...
SELECT * FROM customer INNER JOIN orders ON customer.customer_id = orders.customer_id INNER JOIN products ON orders.product_price = products.product_price;
SELECT * FROM customer INNER JOIN orders ON customer.customer_id = orders.customer_id INNER JOIN products ON orders.product_price = products.product_price INNER JOIN seller ON products.product_id = seller.product_id;


/* LEFT JOIN */
SELECT * FROM customer LEFT JOIN orders ON customer.customer_id = orders.customer_id;
SELECT * FROM customer LEFT JOIN orders ON customer.customer_id = orders.customer_id LEFT JOIN products ON orders.product_price = products.product_price;
SELECT * FROM customer LEFT JOIN orders ON customer.customer_id = orders.customer_id LEFT JOIN products ON orders.product_price = products.product_price LEFT JOIN seller ON products.product_id = seller.product_id;


/* RIGHT JOIN */
SELECT * FROM customer RIGHT JOIN orders ON customer.customer_id = orders.customer_id;
SELECT * FROM customer RIGHT JOIN orders ON customer.customer_id = orders.customer_id RIGHT JOIN products ON orders.product_price = products.product_price;
SELECT * FROM customer RIGHT JOIN orders ON customer.customer_id = orders.customer_id RIGHT JOIN products ON orders.product_price = products.product_price RIGHT JOIN seller ON products.product_id = seller.product_id;
